    ...
    <div className="w-full bg-white flex flex-col justify-between min-h-screen max-w-[794px]">
      <div className="px-10 pt-6 pb-6">
        ...
        <p className="text-xs font-normal text-black-gray-100 pt-4">
          ...
          Career Guidance Test, which will form the foundation of the career
          counseling process. Based on the comprehensive report generated by the
          test, you will be able to provide students with tailored advice,
          ensuring they are supported in making informed career choices.
        </p>
        <p className="text-xs font-normal text-black-gray-100 pt-4">
        ...
        <div className="pt-4">
          ...
          <p className="text-xs font-normal text-black-gray-100 pt-2">
            By scientifically assessing these dimensions, the Career Guidance
            Test offers deeper insights into a student’s unique strengths,
            aspirations, and areas for growth. A key feature of this test is its
            ability to provide personalized career recommendations based on a
            combination of the student’s top abilities, primary interests, and
            dominant personality traits. This approach ensures that the career
            paths suggested are not only aligned with the student’s intrinsic
            motivations and competencies but also support their long-term life
            goals, promoting both personal satisfaction and professional
            success.
          </p>
          <p className="text-xs font-normal text-black-gray-100 pt-2">
    ...
    <div className="w-full bg-white flex flex-col justify-between min-h-screen max-w-[794px]">
      <div className="px-10 pt-6 pb-6">
        ...
        <p className="text-xs font-normal text-black-gray-100 pt-4">
          ...
          traits, and learning skills and habits. To gain a comprehensive
        ...
        <p className="text-xs font-normal text-black-gray-100 pt-2">
          1.&nbsp;<span className="font-bold">English Verbal Ability</span>
          &nbsp; refers to the cognitive skill that enables an individual to
          understand, interpret, and use language effectively. In this
          assessment, it focuses on evaluating comprehension and the ability to
          manipulate language in written form, such as recognizing word
          meanings, sentence structure, and context.
        </p>
        <p className="text-xs font-normal text-black-gray-100 pt-1">
          Students with strong English Verbal Ability are likely to excel in
          fields like Creative Writing, Journalism, Teaching, and
          Communications, where reading comprehension and effective use of
          language are key.
        </p>
        <p className="text-xs font-normal text-black-gray-100 pt-2">
    ...
    <div className="w-full bg-white flex flex-col justify-between min-h-screen max-w-[794px]">
      <div className="px-10 pt-6 pb-6">
        ...
        <p className="text-xs font-normal text-black-gray-100 pt-2">
          5.&nbsp;{" "}
          <span className="font-bold">
            Agriculture and Environmental Interest{" "}
          </span>
        ...
        <p className="text-xs font-normal text-black-gray-100 pt-1">
          Students with high Agriculture and Environmental Interest may pursue
          careers in fields like Agricultural Science, Agribusiness Management,
          Agricultural Engineering, Agronomy, Livestock Management, Food
          Science, Environmental Conservation, Rural Development, Agricultural
          Education, Horticulture, Aquaculture, Sustainability, Food Security,
          Food Technology, and Gardening.
        </p>
      ...
      <div className="px-10 pt-6 pb-6">
        ...
        <div className="pt-5">
          ...
          <p className="text-xs font-normal text-black-gray-100 pt-2">
            ...
            the section on learning skills and habits.
          </p>
        </div>
      </div>
    ...
    <div className="w-full bg-white flex flex-col justify-between min-h-screen max-w-[794px]">
      <div className="px-10 pt-6 pb-6">
        ...
        <h1 className="text-base font-normal text-primary uppercase pt-6 tracking-[1.5px]">
          7.3.2.4 Learning Skills & Habits
        </h1>
        <p className="text-xs font-normal text-black-gray-100 pt-2">
          Learning Skills and Habits form the backbone of a student’s ability to
          acquire knowledge, apply it effectively, and sustain personal and
          academic growth over time. These skills and habits reflect how a
          learner approaches tasks, manages challenges, uses resources, and
          maintains their well-being — all of which significantly influence both
          academic achievement and future career success.
        </p>
        <p className="text-xs font-normal text-black-gray-100 pt-2">
          Understanding a student’s learning skills and habits, educators and
          career counselors can gain deep insights into how the individual
          studies, stays motivated, interacts with others, and takes care of
          their mental and physical health. These insights make it possible to
          offer tailored support, guiding students toward strengthening weaker
          areas and building on their existing strengths. For instance, a
          student who studies consistently, manages their time well, and follows
          healthy routines is likely to approach professional responsibilities
          with similar discipline and focus.
        </p>
        <p className="text-xs font-normal text-black-gray-100 pt-2">
          In career guidance assessments, Learning Skills and Habits are divided
          into three main categories: Study Skills, Growth Skills, and Health
          Habits. Each category contains specific competencies that together
          provide a complete picture of how a student learns and develops.
        </p>
              ...
              <div key={`category-${i}`}>
                <ul key={`content-point-${i}`} className="ml-1">
                  <li className="flex items-start gap-1">
                    ...
                    <div className="text-xs font-bold text-black-gray-100">
                      {categoryData?.key}&nbsp;
                      {categoryData.value?.description?.map((item, idx) => (
                        <span
                          key={idx}
                          className={`font-normal mb-3 last:mb-0 ${
                            idx === 0 ? "inline" : "block mt-3"
                          }`}
                        >
                          {item}
                        </span>
          ...
          {chapterSevenData?.introductionCareerGuidance.studySkillsSubPoints.map(
            (categoryData, i: number) => (
              <div key={`category-${i}`}>
                <ul key={`content-point-${i}`} className="ml-1">
                  <li className="flex items-start gap-1">
                    <p className="text-xs font-bold text-black-gray-100">2.</p>
                    <div className="text-xs font-bold text-black-gray-100">
                      {categoryData?.key}&nbsp;
                      {categoryData.value?.description?.map((item, idx) => (
                        <span
  ...
  return (
    <div className="w-full bg-white flex flex-col justify-between min-h-screen max-w-[794px]">
      <div className="px-10 pt-6 pb-6">
        ...
        />
        <p className="text-xs font-normal text-black-gray-100 pt-4">
          3 .<span className="font-bold">Health Habits: </span> &nbsp;Health
          Habits refer to the regular routines and practices that maintain both
          physical health and emotional well-being. These habits support a
          learner’s ability to stay focused, energized, and resilient, even
          during demanding academic periods. By managing stress effectively and
          caring for their body, students can perform at their best in both
          academic and personal contexts.
        </p>

        <p className="text-xs font-normal text-black-gray-100 pt-2">
          caring for their body, students can perform at their best in both
          academic and personal contexts. Strong health habits help students
          maintain consistent energy levels, recover quickly from challenges,
          and prevent burnout. They also play a significant role in sustaining
          attention, mood, and motivation — all essential for effective
          learning. There are 2 competencies assessed under this category:
        ...
        <div className="pt-4">
          {chapterSevenData?.introductionCareerGuidance.healthHabits.map(
            (categoryData, i: number) => (
              <div key={`category-${i}`}>
                <ul key={`content-point-${i}`} className="list-disc ml-6 pt-1">
                  <li>
                    <p className="text-xs font-bold text-black-gray-100">
                      {categoryData?.title}&nbsp;
        ...
        <p className="text-xs font-normal text-black-gray-100 pt-2">
          In this section, we have explored the three key categories of Learning
          Skills and Habits: Study Skills, Growth Skills, and Health Habits.
          Each category plays an essential role in helping students learn
          effectively, adapt to challenges, and prepare for future
          opportunities. Understanding these skills allows educators and career
          counselors to offer targeted guidance, enabling students to build the
          right balance between effective study practices, personal growth
          abilities, and healthy living habits. By developing these areas,
          learners can approach both academic and professional tasks with
    ...
    <div className="w-full bg-white flex flex-col justify-between min-h-screen max-w-[794px]">
      <div className="px-10 pt-6 pb-6">
        ...
        <p className="text-xs font-normal text-black-gray-100 pt-4">
          ...
          personality, and learning skills and habits.
        </p>
        <div className="pt-4">
    ...
    <div className="w-full bg-white flex flex-col justify-between min-h-screen max-w-[794px]">
      <div className="px-10 pt-6 pb-6">
        ...
        <p className="text-xs font-normal text-black-gray-100 pt-2">
          ...
          study skills and habits.Though learning skills don’t directly
          influence career recommendations, they provide valuable guidance to
          counselors. Understanding a student’s strengths and weaknesses in
          areas like time management, organization, and focus can help
          counselors offer tailored strategies that support not only career path
          selection but also academic success. These insights are crucial for
          ensuring the student develops effective study habits, which contribute
          to ongoing growth and achievement, both academically and in their
          chosen career.
        </p>
        <p className="text-xs font-normal text-black-gray-100 pt-2">
